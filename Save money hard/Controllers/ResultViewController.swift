...
final class ResultViewController: UIViewController {
    ...
    @IBOutlet weak var freeMoneyButton: UIButton!
    @IBOutlet weak var emergencyButton: UIButton!
    
    // 버튼에 쉽게 접근하기 위해 배열로 만들어 놓기 (고차함수 사용 가능)
    lazy var buttons: [UIButton] = {
        return [livingButton, investmentButton, freeMoneyButton, emergencyButton]
    }()
...
//        clearButtonColors()
    ...
    func configureUI() {
        ...
        if let calData = self.calData {
            ...
            guard let text = calData.callabel else { return }
